...
[![Maven Central](https://img.shields.io/maven-central/v/com.phoebe.api/phoebe-kotlin)](https://central.sonatype.com/artifact/com.phoebe.api/phoebe-kotlin/0.1.0-alpha.2)
[![javadoc](https://javadoc.io/badge2/com.phoebe.api/phoebe-kotlin/0.1.0-alpha.2/javadoc.svg)](https://javadoc.io/doc/com.phoebe.api/phoebe-kotlin/0.1.0-alpha.2)
...
The REST API documentation can be found on [science.ebird.org](https://science.ebird.org/en/use-ebird-data/download-ebird-data-products). KDocs are available on [javadoc.io](https://javadoc.io/doc/com.phoebe.api/phoebe-kotlin/0.1.0-alpha.2).
...
```kotlin
implementation("com.phoebe.api:phoebe-kotlin:0.1.0-alpha.2")
```
