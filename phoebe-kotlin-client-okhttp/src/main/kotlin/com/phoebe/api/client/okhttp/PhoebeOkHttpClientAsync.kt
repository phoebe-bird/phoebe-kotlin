...
/**
 * A class that allows building an instance of [PhoebeClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class PhoebeOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [PhoebeClientAsync]. */
        fun builder() = Builder()
         ...
         */
        fun fromEnv(): PhoebeClientAsync = builder().fromEnv().build()
    }

    /** A builder for [PhoebeOkHttpClientAsync]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [PhoebeClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PhoebeClientAsync =
            PhoebeClientAsyncImpl(
                clientOptions
                    .httpClient(
