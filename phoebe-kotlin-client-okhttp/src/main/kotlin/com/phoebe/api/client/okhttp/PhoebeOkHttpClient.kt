...
package com.phoebe.api.client.okhttp

import com.fasterxml.jackson.databind.json.JsonMapper
import com.phoebe.api.client.PhoebeClient
import com.phoebe.api.client.PhoebeClientImpl
...
/**
 * A class that allows building an instance of [PhoebeClient] with [OkHttpClient] as the underlying
 * [HttpClient].
 */
class PhoebeOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [PhoebeClient]. */
        fun builder() = Builder()
         ...
         */
        fun fromEnv(): PhoebeClient = builder().fromEnv().build()
    }

    /** A builder for [PhoebeOkHttpClient]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.phoebe.api.core.jsonMapper]. The default is usually sufficient and
         ...
         *
         * Defaults to the production environment: `https://api.ebird.org/v2`.
         */
        ...
        /**
         * Returns an immutable instance of [PhoebeClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PhoebeClient =
            PhoebeClientImpl(
                clientOptions
                    .httpClient(
