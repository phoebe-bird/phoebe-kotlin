...
internal class Top100RetrieveParamsTest {
    ...
    fun pathParams() {
        val params =
            Top100RetrieveParams.builder().regionCode("regionCode").y(0L).m(1L).d(1L).build()
    ...
    fun queryParams() {
        ...
        assertThat(queryParams)
            .isEqualTo(QueryParams.builder().put("maxResults", "1").put("rankedBy", "spp").build())
    }
