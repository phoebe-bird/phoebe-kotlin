...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.phoebe.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.phoebe.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.phoebe.api.** {
    <init>(...);
