...
interface ChecklistService {
     ...
     */
    fun withOptions(modifier: (ClientOptions.Builder) -> Unit): ChecklistService
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: (ClientOptions.Builder) -> Unit): ChecklistService.WithRawResponse
