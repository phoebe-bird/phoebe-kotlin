...
package com.phoebe.api.models.data.observations.nearest.geospecies
...
/**
 * Find the nearest locations where a species has been seen recently. #### Notes The species code is
 * typically a 6-letter code, e.g. barswa for Barn Swallow. You can get complete set of species code
 * from the GET eBird Taxonomy end-point.
 */
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [GeoSpecieListParams].
         *
    ...
    /** A builder for [GeoSpecieListParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(geoSpecieListParams: GeoSpecieListParams) = apply {
            speciesCode = geoSpecieListParams.speciesCode
            lat = geoSpecieListParams.lat
            lng = geoSpecieListParams.lng
            back = geoSpecieListParams.back
            dist = geoSpecieListParams.dist
            hotspot = geoSpecieListParams.hotspot
            includeProvisional = geoSpecieListParams.includeProvisional
            maxResults = geoSpecieListParams.maxResults
            sppLocale = geoSpecieListParams.sppLocale
            additionalHeaders = geoSpecieListParams.additionalHeaders.toBuilder()
        ...
        /**
         * Returns an immutable instance of [GeoSpecieListParams].
         *
