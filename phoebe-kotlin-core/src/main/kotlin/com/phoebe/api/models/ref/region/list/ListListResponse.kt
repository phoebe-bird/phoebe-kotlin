...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(listListResponse: ListListResponse) = apply {
            code = listListResponse.code
            name = listListResponse.name
        ...
        fun build(): ListListResponse =
            ListListResponse(code, name, additionalProperties.toMutableMap())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ListListResponse && code == other.code && name == other.name && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ListListResponse{code=$code, name=$name, additionalProperties=$additionalProperties}"
}
