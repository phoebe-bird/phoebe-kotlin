...
/**
 * Returns the list of supported locale codes and names for species common names, with the last time
 * they were updated. Use the accept-language header to get translated language names when
 * available.
 *
...
private constructor(
    ...
    companion object {
        ...
        fun none(): LocaleListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [LocaleListParams]. */
        fun builder() = Builder()
    }

    /** A builder for [LocaleListParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(localeListParams: LocaleListParams) = apply {
            acceptLanguage = localeListParams.acceptLanguage
            additionalHeaders = localeListParams.additionalHeaders.toBuilder()
            additionalQueryParams = localeListParams.additionalQueryParams.toBuilder()
        }

        fun acceptLanguage(acceptLanguage: String?) = apply { this.acceptLanguage = acceptLanguage }
        ...
        /**
         * Returns an immutable instance of [LocaleListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LocaleListParams =
            LocaleListParams(
                acceptLanguage,
