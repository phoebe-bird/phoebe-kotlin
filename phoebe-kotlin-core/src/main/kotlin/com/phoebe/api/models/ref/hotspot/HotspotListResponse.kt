...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun numSpeciesAllTime(): Int? = numSpeciesAllTime.getNullable("numSpeciesAllTime")
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [HotspotListResponse]. */
        fun builder() = Builder()
    }

    /** A builder for [HotspotListResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(hotspotListResponse: HotspotListResponse) = apply {
            countryCode = hotspotListResponse.countryCode
            lat = hotspotListResponse.lat
            latestObsDt = hotspotListResponse.latestObsDt
            lng = hotspotListResponse.lng
            locId = hotspotListResponse.locId
            locName = hotspotListResponse.locName
            numSpeciesAllTime = hotspotListResponse.numSpeciesAllTime
            subnational1Code = hotspotListResponse.subnational1Code
            subnational2Code = hotspotListResponse.subnational2Code
            additionalProperties = hotspotListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [HotspotListResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): HotspotListResponse =
            HotspotListResponse(
                countryCode,
                lat,
                latestObsDt,
     ...
     *   expected type.
     */
    fun validate(): HotspotListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "HotspotListResponse{countryCode=$countryCode, lat=$lat, latestObsDt=$latestObsDt, lng=$lng, locId=$locId, locName=$locName, numSpeciesAllTime=$numSpeciesAllTime, subnational1Code=$subnational1Code, subnational2Code=$subnational2Code, additionalProperties=$additionalProperties}"
}
