...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): VersionListParams =
            VersionListParams(additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is VersionListParams && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "VersionListParams{additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
