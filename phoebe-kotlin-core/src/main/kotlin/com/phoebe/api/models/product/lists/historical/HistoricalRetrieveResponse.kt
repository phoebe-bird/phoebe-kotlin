...
class HistoricalRetrieveResponse
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [HistoricalRetrieveResponse].
         */
        fun builder() = Builder()
    }

    /** A builder for [HistoricalRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(historicalRetrieveResponse: HistoricalRetrieveResponse) = apply {
            allObsReported = historicalRetrieveResponse.allObsReported
            checklistId = historicalRetrieveResponse.checklistId
            creationDt = historicalRetrieveResponse.creationDt
            durationHrs = historicalRetrieveResponse.durationHrs
            isoObsDate = historicalRetrieveResponse.isoObsDate
            lastEditedDt = historicalRetrieveResponse.lastEditedDt
            loc = historicalRetrieveResponse.loc
            locId = historicalRetrieveResponse.locId
            numObservers = historicalRetrieveResponse.numObservers
            numSpecies = historicalRetrieveResponse.numSpecies
            obs = historicalRetrieveResponse.obs.map { it.toMutableList() }
            obsDt = historicalRetrieveResponse.obsDt
            obsTime = historicalRetrieveResponse.obsTime
            obsTimeValid = historicalRetrieveResponse.obsTimeValid
            projId = historicalRetrieveResponse.projId
            protocolId = historicalRetrieveResponse.protocolId
            subId = historicalRetrieveResponse.subId
            submissionMethodCode = historicalRetrieveResponse.submissionMethodCode
            subnational1Code = historicalRetrieveResponse.subnational1Code
            userDisplayName = historicalRetrieveResponse.userDisplayName
            additionalProperties = historicalRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [HistoricalRetrieveResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): HistoricalRetrieveResponse =
    ...
    fun validate(): HistoricalRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
