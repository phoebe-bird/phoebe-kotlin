...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ChecklistViewResponse]. */
        fun builder() = Builder()
    }

    /** A builder for [ChecklistViewResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(checklistViewResponse: ChecklistViewResponse) = apply {
            allObsReported = checklistViewResponse.allObsReported
            checklistId = checklistViewResponse.checklistId
            creationDt = checklistViewResponse.creationDt
            durationHrs = checklistViewResponse.durationHrs
            isoObsDate = checklistViewResponse.isoObsDate
            lastEditedDt = checklistViewResponse.lastEditedDt
            loc = checklistViewResponse.loc
            locId = checklistViewResponse.locId
            numObservers = checklistViewResponse.numObservers
            numSpecies = checklistViewResponse.numSpecies
            obs = checklistViewResponse.obs.map { it.toMutableList() }
            obsDt = checklistViewResponse.obsDt
            obsTime = checklistViewResponse.obsTime
            obsTimeValid = checklistViewResponse.obsTimeValid
            projId = checklistViewResponse.projId
            protocolId = checklistViewResponse.protocolId
            subId = checklistViewResponse.subId
            submissionMethodCode = checklistViewResponse.submissionMethodCode
            subnational1Code = checklistViewResponse.subnational1Code
            userDisplayName = checklistViewResponse.userDisplayName
            additionalProperties = checklistViewResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ChecklistViewResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ChecklistViewResponse =
    ...
    fun validate(): ChecklistViewResponse = apply {
        if (validated) {
            return@apply
        }
