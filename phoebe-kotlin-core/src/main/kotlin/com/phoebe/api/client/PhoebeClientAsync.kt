...
/**
 * A client for interacting with the Phoebe REST API asynchronously. You can also switch to
...
interface PhoebeClientAsync {
    ...
    interface WithRawResponse {
        ...
        fun ref(): RefServiceAsync.WithRawResponse
    }
}
