...
dependencies {
    testImplementation(project(":phoebe-kotlin"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../phoebe-kotlin-core/src/main/resources/META-INF/proguard/phoebe-kotlin-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.phoebe.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../phoebe-kotlin-core/src/main/resources/META-INF/proguard/phoebe-kotlin-core.pro",
